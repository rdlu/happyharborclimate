...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { apiparams: @station.apiparams, apitype: @station.apitype, lat: @station.lat, lon: @station.lon, name: @station.name, provides: @station.provides }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { apiparams: @station.apiparams, apitype: @station.apitype, lat: @station.lat, lon: @station.lon, name: @station.name, provides: @station.provides }
    assert_redirected_to station_path(assigns(:station))
  end
